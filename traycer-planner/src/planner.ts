...
export class PlanningAgent {
    ...
    private history: Content[]; // Use Content type from SDK
...
**Feedback Request:** Does this fit your goals and constraints?  
    ...
    public async generatePlan(userInput: string): Promise<string> {
        try {
    ...
    public async updatePlan(feedback: string): Promise<string> {
        try {
    ...
    public exportPlan(): { plan: string; timestamp: Date; history: Content[] } {
        return {
