...
const creatorAgent = new CodeSearchAgent({ tools: sharedTools, systemPrompt: `
...
` });
const plannerAgent = new CodeSearchAgent({ tools: sharedTools, systemPrompt: `
...
` });
const reviewerAgent = new CodeSearchAgent({ tools: sharedTools, systemPrompt: `
...
function displayMenu() {
    ...
    console.log(chalk.cyan("🤖 Traycer AI - Creator / Planner / Reviewer"));
...
async function main() {
    console.log(chalk.cyan("🚀 Starting Traycer AI (Creator / Planner / Reviewer)..."));
